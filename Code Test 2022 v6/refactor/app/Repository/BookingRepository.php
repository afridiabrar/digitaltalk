...
class BookingRepository extends BaseRepository
{
...

    {
        ...
        if ($cuser && $cuser->is('customer')) {
            //If you want only user.userMeta instead use of hasMany. You can use hasManyThrough
            ...
            //Why Predefined Values 'customer'?
            $usertype = 'customer';
        } elseif ($cuser && $cuser->is('translator')) {
            $jobs = Job::getTranslatorJobs($cuser->id, 'new');
            $jobs = $jobs->pluck('jobs')->all();
            //Why Predefined Values 'translator'?
            $usertype = 'translator';
        }
        if ($jobs) {
    ...
    public function getUsersJobsHistory($user_id, Request $request)
    {
        ...
        //Insted use of this ifelse condition.Use Ternary Condition here.
        //Sultan Abrar Code
        (isset($page)) ? $pagenum = $page : $pagenum = 1;
        //End Sultan Abrar Code

        //No Proper Naming Convention "cuser"? use snake case like this c_user Or Camel Case cUser
        $cuser = User::find($user_id);
        $usertype = '';
        $emergencyJobs = array();
        $noramlJobs = array();
        if ($cuser && $cuser->is('customer')) {
            //Please Apply Psr2 Here
            ...
            //"Customer" Set this on Users Model Like Static Method .
            $usertype = 'customer';
            ...
            $jobs = $jobs_ids;
            //Please Use snake or camel case .What i saw both are there. work on naming convention
            $noramlJobs = $jobs_ids;
...
//            $jobs['total'] = $totaljobs;
    ...
    public function store($user, $data)
    {
        ...
        if ($user->user_type == env('CUSTOMER_ROLE_ID')) {
            $cuser = $user;
        //For Message create a response Message file in resources->lang->en->responseMessages.php
        //
